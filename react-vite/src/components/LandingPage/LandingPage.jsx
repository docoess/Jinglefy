    ...
    return (
        <div className="landing-page-container">
            ...
            <div className="landing-buttons">
                <NavLink to='/albums' className={"fake-button"}>View all albums</NavLink>
                <NavLink to='/signup' className={"fake-button"}>Create Your Jinglefy account!</NavLink>
                <OpenModalMenuItem  itemText="Log In"
                    modalComponent={<LoginFormModal />} className={"fake-button"}
                    />
            </div>
